...
% loading data
r1=dataset('xlsfile','Input\data');
Asset_Names=r1.Properties.VarNames(2:end);
r1 = sortrows(r1,'date','ascend');
r1=double(r1);
...
for s=1:S
    ...
    % plot Grapgh
    if exist('Rt','var')
        Expt(x,A,r,SenarioName,Asset_Names,PM,Rt,ALPM,xFinal);% Export Simulation data to excell file
        Grph(JustSort,x,A,r,SenarioName,Asset_Names,PM,Rt,ALPM,xFinal);% plot Graph
    else
        Expt(x,A,r,SenarioName,Asset_Names,PM);% Export Simulation data to excell file
        Grph(JustSort,x,A,r,SenarioName,Asset_Names,PM);% plot Graph
    end
